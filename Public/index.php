...
<div id="content-bar">
  ...
  <div style="width:100%; padding: 8px; text-align:center; font-size:26px; border:0px solid red;">
    ...
    <div id="footer2">
      <a id="ahome" href="http://dropinpic.numode-foss.eu" target="_blank" style="color:black;"><img id="logo-hl" src="/DIS_res/DIlogo.png">Powered by DropInPic</a>
    </div>
    <?php endif; ?>&nbsp;
